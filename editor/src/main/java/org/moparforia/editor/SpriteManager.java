...
public class SpriteManager {
    ...
    public int[] getPixelsFromTileCode(int tileCode) {
        if (tileCode == 0) {
            ...
            /**
             * element index's 0=grass, 1=dirt, 2=mud, 3=ice, 4=speed-n, 5=speed-ne, 6=speed-e,
             * 7=speed-se 8=speed-s, 9=speed-sw, 10=speed-w, 11=speed-nw 12=water, 13=piss,
             * 14=grass+water, 15=grass+piss, 16=block, 17=sticky-block 18=bouncy-block,
             * 19=hackblock?!? 20=solid-n, 21=solid-e 22=solid-s 23=solid-w
             *
             * <p>special index's 0=blank, 1=hole, 2=hole, 3=moveable-block, 4=mine, 5=blowmine,
